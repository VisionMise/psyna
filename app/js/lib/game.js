...
import { KeyboardAndMouseInput, GamepadInput, InputDispatcher, InputType } from "./input.js";
export class Game {
    constructor() {
        this.gameStage = null;
        this.controller = [];
    ...
    initGamepadInput() {
        ...
        window.addEventListener('gamepaddisconnected', (event) => {
            ...
            const index = this.controller.findIndex(input => input.type == InputType.Gamepad && input.gamepad.index == gamepad.index);
