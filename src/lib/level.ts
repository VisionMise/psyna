//#region Imports
    ...
    import { BoxCircle, Collider, BoxRect, Shape, Stage, NonCollidable, Size, Position } from "./stage.js";
...
//#region Level Class
    ...
    export class Level {
        ...
        //#region Properties
            ...
            private walkable:NonCollidable[]        = [];
            ...
            private maxEnemyLevel:number            = 1;
        ...
        //#region Getters & Setters
            ...
            public get floor() : NonCollidable[] {
            ...
            public get player() : Player {
                return this.actors.filter(actor => actor instanceof Player)[0] as Player;
            }

            public get enemies() : Enemy[] {
                return this.actors.filter(actor => actor instanceof Enemy) as Enemy[];
            }

            public get walkableArea() : BoxRect {
            ...
            public get walkableAreaScaled() : BoxRect {
        ...
        //#region Private Methods
            ...
            private async loadConfiguration() : Promise<void> {
                ...
                this.enemyTypes = (data?.enemies?.types ?? []).map((type:string) => EnemyType[type]);
            }
            ...
            private generateWalkable(): NonCollidable[] {
                const walkable: NonCollidable[] = [];
            ...
            private isIntersecting(box1: BoxRect, box2: BoxRect): boolean {
            ...
            private async createEnemies(types:EnemyType[]) : Promise<void> {
                ...
                for (let i = 0; i < this.maxEnemies; i++) {
                    ...
                    let position:Position = this.randomPosition();
                    
                    // create the enemy
                    const enemy:Enemy = new Enemy(type, this.stage, position);                    
                }
